...
if ($('.challengeIndex').length > 0) {
    ...
    function onSuccess(position) {
        ...
        var map = new google.maps.Map(document.getElementById("mapArea1"), mapOptions);
...
if ($('.challengeShow').length > 0) {
    ...
    //   $('#destination, #showPath').on('click', findPath);
    // });
    ...
    function onSuccess2(position) {
        ...
        map = new google.maps.Map($("#mapArea2")[0], mapOptions);
